...
public class ChatApplication extends Application
{
	...
	public static void showChatView(String username) throws IOException {
		...
		// Add our comprehensive styles including chat bubbles and UI components
		scene.getStylesheets().add(ChatApplication.class.getResource("fxml/ChatWindowStyle.css").toExternalForm());
